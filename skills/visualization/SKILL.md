...
Generate self-contained HTML files that present code learning as interactive retro-styled games. The primary format is the Oregon Code Trail — a pixel art Oregon Trail-inspired game where the user "travels" through a web framework's request pipeline.
...
<head>
  ...
  <title>Oregon Code Trail — [Framework Name]</title>
...
- `references/oregon-trail.md` — Complete game mechanics and event catalog
