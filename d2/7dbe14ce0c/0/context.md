...
Great. Can we build and push to what's at https://www.davidtran.me/coderegon-trail

### Prompt 28

can you review the comments on https://github.com/dtran320/coderegon-trail/pull/8 and also look into the jekyll build failure
...
some of these aren't legible. if the color of the disk is light, the text should be black instead of white. [Image #6] [Image #7]
...
oops can we start the level server? now we have a JS error. can we lint in the future?

coderegon-trail/:529 Uncaught ReferenceError: Cannot access 'luminance' before initialization
    at createDiskTexture (coderegon-trail/:529:21)
    at coderegon-trail/:585:17
    at Array.forEach (<anonymous>)
    at buildAllDisks (coderegon-trail/:575:10)
    at coderegon-trail/:668:1
